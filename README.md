...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dash-auth-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11318&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dash-auth-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dash-auth` can be installed with:

```
conda install dash-auth
```

It is possible to list all of the versions of `dash-auth` available on your platform with:
